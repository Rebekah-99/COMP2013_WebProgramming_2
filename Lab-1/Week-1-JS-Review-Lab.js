 ...
 */
//WRITE YOUR CODE BELOW
//spread operator to deep copy listings0 to create listing1
const listing1 = {...listing0};
console.log(listing1);
//Adding "isSold" property
console.log(listing1["isSold"] = false);
//Adding "currentOwner"
console.log(listing1["currentOwner"] = "Jane Doe");
 ...
 */
//WRITE YOUR CODE BELOW
console.log(`listing1 has an owner named: ${listing1.currentOwner}`);
console.log(`listing1 address is: ${listing1.address}`);
...
/*************************** 
 *Not sure if allowed for these labs as last semester - but found the Number solution for this to change 
 the string value in price to a number then used the replace function taught last semester to replace the
 unwanted symbols and allow for proper calculations to take place.
 https://www.w3schools.com/js/js_type_conversion.asp - For Number() function learning.
*****************************/
//feeLess450 = 0.025;
//feeMore450 = 0.020;
const realtorFees = (listings) => 
  `Realtor fees are: $${listings.price.replace(/[$,",]/g, '') <= 45000
    ? Number(listings.price.replace(/[$,",]/g, '')) * 0.025
    : Number(listings.price.replace(/[$,",]/g, '')) * 0.020}`;
 ...
 */
//WRITE YOUR CODE BELOW
////////THIS IS NOT DONE PROPERLY YET - STRUCTURE IN PLACE - DEFINITIONS NOT
const listingAscendingly = listings.sort(
  (listingsA, listingsB) => 
    Number(listingsA.price.replace(/[$,",]/g, '')) - 
    Number(listingsB.price.replace(/[$,",]/g, ''))
);
...
Number(listing.propertySummary.builtIn.replace(/["]/g, '')) >= 1990);
